<template>
    <div class="css-5cgeed">
        <div class="css-qdwe4u">
            ...
            <div class="css-8knsro"><a href="입찰 등록 페이지.html"><button type="button" class="css-16iku8x">입찰
                        등록하기</button></a></div>
                    ...
                    <form>
                        <div class="css-17t0ez6">
                            <div class="css-xrnbd4">
                                <div class="css-prvn4i"><label for="name" class="css-8840p9">상품명</label><input
                                        type="text" autocomplete="off" id="name" placeholder="상품명을 입력하세요." name="name"
                                        class="css-14q291r" value=""></div>
                                <div class="css-1m20113"><label class="css-8840p9">카테고리</label>
                                    <div class="css-1og3vwv">
                                        <div class="css-6g4wep">
                                            <div id="select-1" class="css-bjn8wh">
                                                <div id="trigger-1" aria-controls="option-list-1" aria-haspopup="true"
                                                    aria-expanded="false" data-open="false"><button type="button"
                                                        value="1차 선택" class="css-loukex">
                                                        <div class="css-jqqxr7"><span class="css-1lsopo7">1차 선택</span>
                                ...
                                <button type="submit" class="css-10q122i">검색하기</button>
                            </div>
                        </div>
                    </form>
                                        ...
                                        <td role="cell" class="css-k1sij3">
                                            <div class="css-1wnowod"><label class="css-u2o9sw"><svg
                                                        ...
                                                        <path fill="#E5E5E5" fill-rule="evenodd"
                                                            d="M15 3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h10Zm0 1.3H5a.7.7 0 0 0-.694.605L4.3 5v10a.7.7 0 0 0 .605.694L5 15.7h10a.7.7 0 0 0 .694-.605L15.7 15V5a.7.7 0 0 0-.605-.694L15 4.3Z"
                                                            clip-rule="evenodd"></path>
                                                    </svg><input type="checkbox" title="Toggle Row Selected"
                                                        class="css-eivff4" style="cursor: pointer;"></label>
                                            </div>
                                        </td>
                                        <td role="cell" class="css-k1sij3" style="width: 100px">
                                            <div class="css-gpsap0"><button type="button"
                                                    class="css-165uhau">281182659</button></div>
                                        </td>
                                        <td role="cell" class="css-k1sij3">
                                            <div class="css-w39dry">
                                                <form><input type="text" autocomplete="off" maxlength="40"
                                                        class=" css-1fxlnrv" readonly="" name="name" value="가나다라마">
                                                </form>
                                            </div>
                                        </td>
                                        <td role="cell" class="css-k1sij3" style="width: 100px">
                                            <div class="css-1p4iqh6"><input type="text" autocomplete="off"
                                                    class=" css-4b8tol" readonly="" value="30">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="css-1spfi4c">
                            <div class="css-ga3b11">
                                ...
                                <div class="css-1axnh3m">
                                    ...
                                    <p>0<span class="css-c6lzdm">-</span>0</p><button type="button" disabled=""
