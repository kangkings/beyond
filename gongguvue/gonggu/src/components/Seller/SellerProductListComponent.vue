<template>
    <div class="css-5cgeed">
        <div class="css-qdwe4u">
            ...
            <div class="css-8knsro"><a href="./상품등록페이지.html"><button type="button" class="css-16iku8x">상품
                        등록하기</button></a></div>
                                    ...
                                    <div id="select-12" class="css-bjn8wh">
                                        <div id="trigger-12" aria-controls="option-list-12" aria-haspopup="true"
                                            ...
                                            <button type="button" disabled="" name="sort" value="desc"
                                                class="css-1k1iuw5">
                                                <div class="css-9q95zi">최신순<svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <table role="table" class="css-1dfxxj6">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="table-column css-13s4dk6" colspan="1" role="columnheader">상품
                                            설명
                                        </th>
                                    ...
                                    <tr role="row">
                                        ...
                                        <td role="cell" class="css-k1sij3">
                                            <div class="css-1p4iqh6"><input type="text" autocomplete="off"
                                                    class=" css-1e4nmnj" readonly="" value="가나다라마바사아자타차">
                                            </div>
                                        </td>
                                        <td role="cell" class="css-k1sij3">
                                            <div class="css-1mzc4e5"><input type="text" autocomplete="off"
                                                    class=" css-zy9krc" readonly="" value="가방/지갑 > 여성가방 > 클러치백">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
