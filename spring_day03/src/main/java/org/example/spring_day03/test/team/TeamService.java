...
import org.example.spring_day03.test.lecture.LectureRepository;
...
public class TeamService {
    ...
    public TeamService(TeamRepository teamRepository, StudentRepository studentRepository, LectureRepository lectureRepository) {
    ...
    public void create() {
        ...
        List<String> team_fourtrees = Arrays.asList("포트리스", "강태성", "김우혁", "도지민", "서재은", "abc");
